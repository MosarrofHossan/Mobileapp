...
//flag がAのときpenguinsのターン、Bのときbearのターン
let flag = "pen-flag";
...
//Arrayに変換
//https://developer.mozilla.org/ja/docs/web//JavaScript/Global_Object/Array/from
...
//Win or Lose Judgment Line 
//*******************************************
//JavaScriptでfillterを使う：https://techacademy.jp/magazine/15575
...
//*******************************************
//クリックしたsquareに,penguinsかbearを表示。画面を表示したsquareはクリックできないようにする、win or Judgmentの呼び出し
a_1.addEventListener("click",
    function( ) {
        isSelect(a_1);
    },false
);
//上記のコーディングと下記のコーディングは同じ
...
//勝敗判定
//****************************************
//classListの使う:https://qiita.com/tomokichi_ruby/items
