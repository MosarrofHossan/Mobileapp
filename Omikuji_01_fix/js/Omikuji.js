...
btn1.addEventListener("click",
  function() {
    ...
    let resultFontSize = ["45px","40px","35px","30px","25px","20px"];
    let resultMaxSpeed = ["12","10",,"8","6","5","5"];
    let resultMaxSize  = ["30","28","24","20","16","15"];
    let resultImage    = ["img/star.png","img/sakura_hanabira.png","img/star.png","img/star.png","img/star.png","img/star.png"];
